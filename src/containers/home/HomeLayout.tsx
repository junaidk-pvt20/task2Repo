...
import { IJobDetails, IRequisitionDetails, IInterViewSettings } from "@src/interface/forms";
...
const HomeLayout = () => {
  ...
  const [requisitionDetails, setRequistionDetails] = useState<IRequisitionDetails>({
    requisitionTitle: "",
    noOfOpenings: 0,
    urgency: "",
    gender: "",
            ...
            <TabPanels>
              <TabPanel>
                <RequisitionForm handleTab={handlePage}
                  setDetails={setRequistionDetails}
